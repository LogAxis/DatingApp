...
const title = "Dating with Vava Reviews";
const desc = "Hear directly from our community members about how the Dating with Vava experience has positively impacted them. Join us and become part of a larger family!.";

let StorySectionContentList = [
    {
        imgUrl: 'assets/images/story/01.jpg',
        imgAlt: 'Dating Thumb',
        title: 'My name is Thato and would like to share my experience with @DatingleVava',
        activity: 'Pretoria',
